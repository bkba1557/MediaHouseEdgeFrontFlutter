...
class ServiceFolderItemsScreen extends StatefulWidget {
  final String serviceCategory;
  final String serviceTitle;
  final String collectionKey;
  final String collectionTitle;

  const ServiceFolderItemsScreen({
    super.key,
  ...
  @override
  State<ServiceFolderItemsScreen> createState() =>
      _ServiceFolderItemsScreenState();
}

class _ServiceFolderItemsScreenState extends State<ServiceFolderItemsScreen> {
  ...
  Future<void> _load() async {
    await context.read<MediaProvider>().fetchMedia(
  ...
  List<Media> _folderItems(List<Media> all) {
    final items = all
        .where(
          (m) =>
              m.category == widget.serviceCategory &&
                            ...
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (_) => VideoPlayerScreen(
                                  media: media,
                                  playlist: playlist,
                                  playlistTitle: widget.collectionTitle,
                                ),
                              ),
                            );
                          },
